...
export default function AudioVideoSurveillancePage() {
 ...
 <section className="gsv-local-banner gsv-managed-it-banner">
  ...
  <p>
   ...
   infrastructure. We combine premium audio architectures like Russound and Marantz with
   masterfully calibrated media rooms and smart surveillance networks. The result is a
   unified, intuitive ecosystem that delivers pristine audio-visual immersion while
   maintaining complete data privacy and physical perimeter security.
  </p>
 </section>
 ...
 <section className="gsv-section gsv-managed-next-step-section">
  ...
  <div className="gsv-managed-next-step-card">
   <div className="gsv-managed-next-step-copy">
    ...
    <p>Schedule a dedicated 30-minute residential audio-visual consultation. We'll review your property layout, evaluate your entertainment preferences, discuss security requirements, and map a clear structural path for whole-home audio, dedicated theaters, and localized AI surveillance grids.</p>
